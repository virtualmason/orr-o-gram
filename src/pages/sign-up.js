             ...
             <div className="flex flex-col w-2/5 items-center bg-white p-4 border border-grat-primary mb-4">
                 ...
                 <input 
                   ...
                   <input 
                     ...
                     type="submit"
                     className={`bg-blue-500 text-white w-full rounded h-10 font-bold ${isInvalid && 'opacity-50'}`} >Sign Up</button>
                 </form>
             </div>
             <div className="flex mt-4 justify-center items-center flex-col w-full bg-white p-4 border border-gray-primary">
    <p className="text-sm">Have an account?{' '}</p>
    <Link to={ROUTES.LOGIN} className="font-bold text-blue-medium">Sign up</Link>
             </div>
        </div>
